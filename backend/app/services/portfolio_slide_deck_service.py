...
def assemble_portfolio_slide_deck(
    ...
    slides.append({
        ...
        "narrative": {
            "subtitle": (
                f"{aggregate.get('property_count', 0)} Properties "
    ...
    slides.append({
        ...
        "viz_data": {
            ...
            "daily_burn": {
                "daily_amount": aggregate.get("total_daily_burn", 0),
                "monthly_amount": aggregate.get("total_monthly_cost", 0),
                "annual_amount": aggregate.get("total_monthly_cost", 0) * 12,
            },
        },
        "layout": {
    ...
    slides.append({
        ...
        "viz_data": {
            "daily_burn": aggregate.get("total_daily_burn", 0),
            "monthly_cost": aggregate.get("total_monthly_cost", 0),
