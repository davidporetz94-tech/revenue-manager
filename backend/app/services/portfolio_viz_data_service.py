...
def generate_portfolio_kpi_cards(aggregate: dict) -> list[dict]:
    ...
    return [
        ...
        {"label": "Daily Burn", "value": aggregate.get("total_daily_burn", 0), "format": "dollar", "suffix": "/day"},
        {"label": "Monthly Cost", "value": aggregate.get("total_monthly_cost", 0), "format": "dollar", "suffix": "/mo"},
        {"label": "Properties", "value": aggregate.get("property_count", 0), "format": "number"},
    ]
